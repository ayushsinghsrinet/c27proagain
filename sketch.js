...
holder1=new box(500,50,20,02)
t1=Bodies.circle(500,90,60);
World.add(world,t1);
var a={
bodyA:t1,
bodyB:holder1.body,
...
World.add(world,m)
    ...
    holder2=new box(400,50,20,02)
    t2=Bodies.circle(400,90,60);
    World.add(world,t2);
    var ta={
    bodyA:t2,
    bodyB:holder2.body,
...
holder3=new box(300,50,20,02)
t3=Bodies.circle(300,90,60);
World.add(world,t3);
var ri={
bodyA:t3,
bodyB:holder3.body,
...
holder4=new box(200,50,20,02)
t4=Bodies.circle(200,90,60);
World.add(world,t4);
var us={
bodyA:t4,
bodyB:holder4.body,
...
holder5=new box(100,50,20,02)
t5=Bodies.circle(100,90,60)
World.add(world,t5);
var us={
bodyA:t5,
bodyB:holder4.body,
...
function draw(){
 ...
 //ellipseMode(RADIUS)
   ...
   //strokeWeight(4)
  //  line(t.position.x,t.position.y,holder1.position.x,holder1.position.y)
    ...
    strokeWeight(4)
    line(t2.position.x,t2.position.y,holder1.body.position.x,holder1.body.position.y)


    ellipseMode(RADIUS)
    ellipse(t3.position.x,t3.position.y,60)
    strokeWeight(4)
    line(t3.position.x,t3.position.y,holder1.body.position.x,holder1.body.position.y);

    ellipseMode(RADIUS)
    ellipse(t4.position.x,t4.position.y,60)
    strokeWeight(4)
    line(t4.position.x,t4.position.y,holder1.body.position.x,holder1.body.position.y)

    ellipseMode(RADIUS)
    ellipse(t5.position.x,t5.position.y,60)
    strokeWeight(4)
    line(t5.position.x,t5.position.y,holder1.body.position.x,holder1.body.position.y)
...
function Key(){
    if(keyWentDown("up")){
        Matter.Body.applyForce(t5,{x:t5.position.x,y:t5.position.y},{x:-1.5,y:3})
    }
}